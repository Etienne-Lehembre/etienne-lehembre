...
**2024 - 2025: AI4Science - Summer School on Advancing Scientific Discovery with AI (30h).**\
Summer school providing participants with an in-depth understanding of using AI to accelerate and enhance the scientific discovery process. It covers multiple topics, such as machine learning for scientific data analysis, AI-based experimental design and optimization, generative models in scientific applications, and integrating AI in physical simulations and theoretical frameworks.
